...
export function ControlUiThemeProvider({ theme, className, style, children }: ControlUiThemeProviderProps) {
    ...
    return (
        <ControlUiThemeContext.Provider value={theme}>
            <div className={cx('vdsp-control-ui-theme', className)} style={themeStyle}>
                {children}
            </div>
