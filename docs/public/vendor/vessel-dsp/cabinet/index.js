...
function addCabinetLabels(root, layout) {
    ...
    const brand = vectorTextLabel("cabinet-brand-label", layout.brandName, layout.appearance.brandLabelColor, layout.appearance.brandLabelFontSizeMm, layout.appearance.labelFontFamily, 2);
    ...
    const model = vectorTextLabel("cabinet-model-label", layout.modelName, layout.appearance.modelLabelColor, layout.appearance.modelLabelFontSizeMm, layout.appearance.labelFontFamily, 2);
