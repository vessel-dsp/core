...
//
// Vendored from the "Serenity Shader" WebGL CRT effect.
// Source: https://github.com/gingerbeardman/webgl-crt-shader
// Copyright (c) 2025 Matt Sephton (@gingerbeardman). MIT License.
//
// Exposed as a Three.js ShaderPass-style object ({ uniforms, vertexShader,
// fragmentShader }) so it can drive a full-screen post-processing quad. The
// runtime stompbox viewer applies it as a screen-space pass over both the
// orbit (3D) and orthographic top (2D) preview modes.
