...
>
	...
	<StompboxGlbViewer src="/core/examples/stompbox-mxr-style-preview.glb" view="top" interactive={false} height="520px" backgroundColor="#000000" gridColor="#cccccc" gridOpacity={0.2} toon={true} toonEdgeColor="#69145a" linework={true} lineworkColor="#ffffff" />
