...
describe("release metadata", () => {
	test("pins the current package release and changelog entry", async () => {
		...
		expect(core.version).toBe("0.6.28");
		...
		expect(VERSION).toBe("0.6.28");
		expect(distIndex).toContain('export const VERSION = "0.6.28";');
		expect(distTypes).toContain('export declare const VERSION = "0.6.28";');
