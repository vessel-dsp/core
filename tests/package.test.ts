...
describe("release metadata", () => {
	test("pins the current package release and changelog entry", async () => {
		...
		expect(core.version).toBe("0.6.10");
		expect(stompbox.version).toBe("0.6.10");
		expect(controlUi.version).toBe("0.6.10");
		expect(visualEffects.version).toBe("0.6.10");
		expect(amp.version).toBe("0.6.10");
		expect(cabinet.version).toBe("0.6.10");
		expect(VERSION).toBe("0.6.10");
		expect(distIndex).toContain('export const VERSION = "0.6.10";');
		expect(distTypes).toContain('export declare const VERSION = "0.6.10";');
