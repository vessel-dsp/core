...
describe("release metadata", () => {
	test("pins the current package release and changelog entry", async () => {
		...
		expect(core.version).toBe("0.6.9");
		expect(stompbox.version).toBe("0.6.9");
		expect(controlUi.version).toBe("0.6.9");
		expect(visualEffects.version).toBe("0.6.9");
		expect(amp.version).toBe("0.6.9");
		expect(cabinet.version).toBe("0.6.9");
		expect(VERSION).toBe("0.6.9");
		expect(distIndex).toContain('export const VERSION = "0.6.9";');
		expect(distTypes).toContain('export declare const VERSION = "0.6.9";');
