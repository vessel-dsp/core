...
describe("release metadata", () => {
	test("pins the current package release and changelog entry", async () => {
		...
		expect(core.version).toBe("0.6.11");
		expect(stompbox.version).toBe("0.6.11");
		expect(controlUi.version).toBe("0.6.11");
		expect(visualEffects.version).toBe("0.6.11");
		expect(amp.version).toBe("0.6.11");
		expect(cabinet.version).toBe("0.6.11");
		expect(VERSION).toBe("0.6.11");
		expect(distIndex).toContain('export const VERSION = "0.6.11";');
		expect(distTypes).toContain('export declare const VERSION = "0.6.11";');
